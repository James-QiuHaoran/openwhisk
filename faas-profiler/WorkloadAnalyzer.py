...
def main():
    ...
    if FAAS_ROOT in config_file:
        ...
        [test_name, config_df] = ConstructConfigDataframe(FAAS_ROOT + '/525_experiments/' + config_file)
    
    read_results = True if read_results else False
    ...
    # intervals between two consecutive invocations (in ms)
    ...
    try:
        ...
        print('Avg invocation period (interval between 2 consecutive invocations): ' + str(mean_invocation_period))
        print('Avg invocation rate (#/s): ' + str(1000.0/mean_invocation_period))
    except:
    ...
    if options.plot:
        ...
        if options.save_plot:
            ...
            save_plot = False
        TestDataframePlotter(save_plot, test_df, cgroups_df=None)
